...
function preload() {
    ...
    game.load.image('background', '../images/invaders/background2.png');
...
function enemyFires () {
    ...
    if (enemyBullet && livingEnemies.length > 0)
    {
        ...
        // increase firingrate for enemies for each level, first level = each 2 seconds
...
function restart () {
    ...
    //  A new level starts, nullstill score hvis nytt spill
    if (level == 0) {
        score = 0;
    }
    level++;
